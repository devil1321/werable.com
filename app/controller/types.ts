...
export enum ShopTypes {
    ...
    SHOP_SET_FAVORUITES = 'SHOP_SET_FAVORUITES',
    SHOP_ADD_FAVORUITE = 'SHOP_ADD_FAVORUITE',
    SHOP_REMOVE_FAVORUITE = 'SHOP_REMOVE_FAVORUITE'
}
...
export enum APITypes {
    ...
    API_SET_PROFILE = 'API_SET_PROFILE',
...
export enum PrintfulTypes {
    ...
    PRINTFUL_SET_ALL_SYNC_PRODUCTS = 'PRINTFUL_SET_ALL_SYNC_PRODUCTS',
