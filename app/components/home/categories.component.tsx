...
const Categories = () => {
  ...
  return (
    <div className='home-categories relative left-[2%] top-0 flex justify-center items-start flex-wrap lg:flex-nowrap'>
      <div className="home-categories-category relative top-0 left-0 min-w-max relative -left-[10%] lg:left-[40%] xl:left-[30%] top-0">
      ...
      <div className="home-categories-category relative top-0 left-0 min-w-max relative -top-[650px] lg:top-0 left-0">
      ...
      <div className="home-categories-category relative top-0 left-0 min-w-max relative -left-[15%] lg:-left-[7%] xl:-left-[5%] top-[-630px] lg:top-0">
      ...
      <div className="home-categories-category relative top-0 left-0 min-w-max relative -left-[5%] lg:-left-[44%] xl:-left-[34%] -top-[1300px] lg:top-0">
