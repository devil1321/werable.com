...
const Carousel = () => {
  ...
  return (
    <div className='home-carousel mb-12 w-[100vw] md:h-[50vh] lg:h-[100vh] xl:h-[100vh] relative top-0 left-0'>
      <div className="home-carousel-controls absolute top-[45%] left-1/2 -translate-y-1/2 -translate-x-1/2 flex justify-between items-center z-10 w-[80%]">
        <div onMouseEnter={()=>handleControl(prevRef)} onMouseLeave={()=>handleControl(prevRef)} className="cursor-pointer transition-all hover:bg-white hover:opacity-30 home-carousel-prev rounded-full bg-neutral-300 opacity-20 p-1 md:p-3" onClick={()=>handlePrev()}>
        ...
        <div onMouseEnter={()=>handleControl(nextRef)} onMouseLeave={()=>handleControl(nextRef)} className="cursor-pointer transition-all hover:bg-white hover:opacity-30 home-carousel-next rounded-full bg-neutral-300 opacity-20 p-1 md:p-3" onClick={()=>handleNext()}>
      ...
      <div className="home-carousel-feature relative z-10 top-0 left-0">
        <div className="home-carousel-feature-controls absolute md:-top-[100px] lg:-top-[50px] left-1/2 z-10 -translate-x-1/2 flex gap-5">
